...
export const playingAtom = atom('lrm-playing', false)

/** Whether the camera eases to follow the sled while playing. */
export const followAtom = atom('lrm-follow', true)

/** Whether surface sounds are muted. Off (audible) by default. */
export const mutedAtom = atom('lrm-muted', false)
 ...
 */
export const showCollisionsAtom = atom('lrm-showCollisions', false)

/** Page-space point the sled spawns from at the start of a run. */
export const startPointAtom = atom<Vec2>('lrm-startPoint', { x: 200, y: 100 })
 ...
 */
export const resetNonceAtom = atom('lrm-resetNonce', 0)

/** Live run telemetry the rider publishes for the panel. */
export const statsAtom = atom('lrm-stats', { distance: 0, speed: 0 })

/** Checkpoint progress: how many of `total` flags collected this run. */
export const scoreAtom = atom('lrm-score', { collected: 0, total: 0 })
