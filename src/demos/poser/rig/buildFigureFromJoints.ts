...
const BONES: BoneFromJoints[] = [
	// pelvis: a tiny hub at the pelvis marker, oriented toward the chest but capped
	// short so the spine (which pins to its tail) still starts at the pelvis.
	{ name: 'pelvis', head: 'pelvis', tail: 'chest', size: 'l', color: SPINE, minLength: 12, maxLength: 12 },
	...
	{ name: 'clavicle-l', head: 'chest', tail: 'shoulder-l', size: 's', color: CONNECT, parentBone: 'neck', minLength: 6 },
	{ name: 'clavicle-r', head: 'chest', tail: 'shoulder-r', size: 's', color: CONNECT, parentBone: 'neck', minLength: 6 },
