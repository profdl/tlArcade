/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b8560c0ecff47c19ca180cfe20098ed)
// Runtime types generated with workerd@1.20260701.1 2025-05-08 nodejs_compat
interface __BaseEnv_Env {
	TLDRAW_BUCKET: R2Bucket;
	TLDRAW_DURABLE_OBJECT: DurableObjectNamespace<import("./worker/worker").TldrawDurableObject>;
	ANT_MOVER_DURABLE_OBJECT: DurableObjectNamespace<import("./worker/worker").AntMoverDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/worker");
		durableNamespaces: "TldrawDurableObject" | "AntMoverDurableObject";
	}
